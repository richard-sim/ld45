...
public class RobotController : MonoBehaviour
{
    ...
    private RobotControls m_Controls;
    ...
    private void UpdateFollowCamera()
    {
        ...
        m_FollowCamera.gameObject.transform.LookAt(this.transform.position + transform.TransformDirection(lookAtOffset));
    }
